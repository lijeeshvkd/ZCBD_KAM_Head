sap.ui.define([
    ...
    "sap/m/library",
    "sap/m/TextArea",
    "zpj/pro/sd/sk/zcbdkamhead/model/formatter",
    "sap/m/MessageBox",
    "sap/m/PDFViewer",
    ...
    function (Controller, JSONModel, Core, Dialog, Button, Label, mobileLibrary, TextArea, formatter, MessageBox, PDFViewer,
        ...
        return Controller.extend("zpj.pro.sd.sk.zcbdkamhead.controller.View2", {
            formatter: formatter,
            onInit: function () {
            ...
            onSourceHelp: function (oEvent) {
                ...
                if (!this._sourceFrag) {
                    this._sourceFrag = sap.ui.xmlfragment("zpj.pro.sd.sk.zcbdkamhead.view.fragments.source", this);
            ...
            onShowAttachmentsLinkPress: function () {
                ...
                this.getViewSettingsDialog(
                    "zpj.pro.sd.sk.zcbdkamhead.view.fragments.View2.attachmentPopUp"
