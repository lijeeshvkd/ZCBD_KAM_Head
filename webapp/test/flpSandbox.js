					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CBD KAM Head",
									"targetURL": "#zpjprosdskzcbdkamhead-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zpjprosdskzprovertihead-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpj.pro.sd.sk.zcbdkamhead",
									"url": sap.ui.require.toUrl("zpj/pro/sd/sk/zcbdkamhead")
								}
							}
						}
					}
